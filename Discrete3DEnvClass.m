classdef Discrete3DEnvClass < rl.env.MATLABEnvironment
   % NavigationDiscreteEnv random target and random initial position
    ...
    %% Methods
    methods
        function this = Discrete3DEnvClass()
        ...
        function state = reset(this)
            ...
            while(~posFound)
                pos = [randi(19); ...
                    randi(19); ...
                    randi(19)];
                if pos(3) ~= 1 % the robot initial position is on the ground. 
                    % Check if it is on the top of a building
                    pos_check = pos;
                    pos_check(3) = pos(3)-1;
                ...
                else % the robot initial position is on the ground
            ...
            while(~posFoundt)
                ...
                if pos(3) ~= 1
                    ...
                    c = this.Map(pos(1),pos(2),pos(3)) == 0 && pos(1)~=this.Robot.x && pos(2)~=this.Robot.y && pos(3)~=this.Robot.z;
                    if c
                        posFoundt = true;
                        this.Goal.x  = pos(1);
                        this.Goal.y  = pos(2);
